...
> Discord member manager, bulk kick prune inactive members 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

🧹 &nbsp;**Prune inactive** — remove members who haven't chatted in X days

👻 &nbsp;**Ghost detection** — find zero-message accounts

📊 &nbsp;**Activity report** — see member activity before acting

✅ &nbsp;**Whitelist** — protect specific members

📋 &nbsp;**Dry run** — preview who would be removed

🔔 &nbsp;**Notify** — optionally DM members before removal
